...
<br/><br/><br/><br/><br/><br/>
	<div id="footer">
		...
		<p style="font-size: 11px; text-align: center;"><abbr title="Anemiafreeworld@gmail.com">Contact Us</abbr> | Visit Again | Stay Healthy | <a href="feedback.php" style="font-size: 11px;">FeedBack</a></p>
		<hr/>
		...
		<ul id="credits">
			...
			<span id="footright2">Ms. Rutvi Thakar</span>
		</p>
	</div>
